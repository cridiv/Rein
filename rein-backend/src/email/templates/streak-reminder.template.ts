...
export const streakReminderTemplate = (data: StreakReminderData): string => {
  const content = `
    <h1>🔥 Don't break your ${data.currentStreak}-day streak!</h1>
              ...
              <p>
                You haven't completed any tasks today, and your
                <strong>${data.currentStreak}-day streak</strong> is at risk!
              </p>
              ...
              <p style="margin-top: 24px">
                <strong>Take just 5 minutes right now</strong> to keep your
                momentum going. Every day counts!
              </p>

              <a href="${data.appLink}" class="button"> Complete Tasks Now </a>

              <p style="margin-top: 32px; color: #71717a; font-size: 14px">
                <em
                  >Tip: Set a daily reminder in your calendar to check off your
                  tasks. The best time to build habits is at the same time every
                  day.</em
                >
              </p>
