...
export const welcomeTemplate = (data: WelcomeEmailData): string => {
  const content = `
   <h1>🎯 Your journey to "${data.resolutionTitle}" begins now!</h1>
              ...
              <p>
                Congratulations on taking the first step! You've just created
                your first resolution, and we're excited to be part of your
                journey.
              </p>
              ...
              <div class="stats-box">
                ...
                <div class="stat-item">
                  ...
                  ${data.resolutionTitle}
                </div>
              </div>

              <h2
                style="font-size: 18px; margin: 32px 0 16px 0; color: #18181b"
              >
                What's Next?
              </h2>

              <p>
                Your first task is scheduled for
                <strong>${data.firstNodeDate}</strong>:
              </p>
              ...
              <p>
                <strong>Pro tip:</strong> Build a streak by completing tasks
                daily. Consistency is the key to achieving your goals!
              </p>
              ...
              <p style="margin-top: 32px; color: #71717a; font-size: 14px">
                Need help getting started? Reply to this email — we're here to
                help!
              </p>
